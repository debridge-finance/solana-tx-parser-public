    ...
    for (const log of logs) {
        ...
        if (match.groups.programInvoke) {
            ...
            if (lastProgram != match.groups.successResultProgramId)
                throw new Error("callstack mismatch");
